...
namespace cbhk_environment.Generators.RecipeGenerator.Components
{
    ...
    /// Furnace.xaml 的交互逻辑
    /// </summary>
    public partial class Furnace : UserControl
    {
        public Furnace()
        {
            InitializeComponent();
    ...
    public class furnaceDataContext:ObservableObject
    {
        ...
        public void MultiMaterialGrid_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Furnace furnace = MultiMaterialGrid.FindParent<Furnace>();
            MultiMaterialSource = furnace.Resources["MultiModeItemViewSource"] as CollectionViewSource;
        ...
        {
            Furnace furnace = MaterialItem.FindParent<Furnace>();
            await furnace.Dispatcher.InvokeAsync(() =>
            {
