...
{
    /// <summary>
    /// BlastFurnace.xaml 的交互逻辑
    /// </summary>
    public partial class BlastFurnace : UserControl
    {
        public BlastFurnace()
        {
            InitializeComponent();
    ...
    public class blastFurnaceDataContext : ObservableObject
    {
        ...
        public void MultiMaterialGrid_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            BlastFurnace blastFurnace = MultiMaterialGrid.FindParent<BlastFurnace>();
        ...
        {
            BlastFurnace blastFurnace = MaterialItem.FindParent<BlastFurnace>();
