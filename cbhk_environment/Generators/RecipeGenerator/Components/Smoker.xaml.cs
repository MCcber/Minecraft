...
namespace cbhk_environment.Generators.RecipeGenerator.Components
{
    ...
    public class smokerDataContext : ObservableObject
    {
        /// <summary>
        /// 运行配方
        /// </summary>
        ...
        public void MultiMaterialGrid_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Smoker smoker = MultiMaterialGrid.FindParent<Smoker>();
            MultiMaterialSource = smoker.Resources["MultiModeItemViewSource"] as CollectionViewSource;
        ...
        {
            Smoker smoker = MaterialItem.FindParent<Smoker>();
            await smoker.Dispatcher.InvokeAsync(() =>
            {
