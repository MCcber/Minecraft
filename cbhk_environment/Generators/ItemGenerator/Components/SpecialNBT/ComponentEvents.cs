...
namespace cbhk_environment.Generators.ItemGenerator.Components.SpecialNBT
{
    public class ComponentEvents
    {
        ...
        public void ValueChangedHandler(object sender, RoutedEventArgs e)
        {
            ...
            int currentIndex = 0;
            ItemPages itemPages = parent.FindParent<ItemPages>();
            ...
            if (!itemPages.SpecialTagsResult.ContainsKey(itemPages.SelectedItemIdString))
                itemPages.SpecialTagsResult.Add(itemPages.SelectedItemIdString, new System.Collections.ObjectModel.ObservableCollection<NBTDataStructure>());
            #endregion
            ...
            if(sender is Accordion && (sender as FrameworkElement).Uid == "StewEffectList")
            {
                ...
                itemPages.SpecialTagsResult[itemPages.SelectedItemIdString].Add(dataStructure);
                currentIndex = itemPages.SpecialTagsResult[itemPages.SelectedItemIdString].Count - 1;
                propertyPath = new PropertyPath("SpecialTagsResult[" + itemPages.SelectedItemIdString + "][" + currentIndex + "]");
            ...
            if (sender is TextBox)
            {
                ...
                itemPages.SpecialTagsResult[itemPages.SelectedItemIdString].Add(textBox.Tag as NBTDataStructure);
                currentIndex = itemPages.SpecialTagsResult[itemPages.SelectedItemIdString].Count - 1;
                propertyPath = new PropertyPath("SpecialTagsResult[" + itemPages.SelectedItemIdString + "][" + currentIndex + "]");
        ...
        public void DebugProperties_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (stackPanel.Children.Count > 0)
            {
                foreach (DebugProperties debugProperties in stackPanel.Children)
                {
                    ...
                    currentID = MainWindow.BlockNameAndID[selectedItem.ComboBoxItemText];
